...
const platforms = [
  {
    ...
    handle: siteConfig.handles.tiktok,
  ...
  {
    name: "YouTube",
    stat: siteConfig.stats.youtube,
    url: siteConfig.social.youtube,
    handle: siteConfig.handles.youtube,
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white-soft mb-4">
            {t(translations.socialSection.title, lang)}
          </h2>
          <p className="text-gold text-lg uppercase tracking-wider">
            {t(translations.socialSection.subtitle, lang)}
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {platforms.map((platform, i) => (
            <motion.a
              ...
              className="card-luxury rounded-sm p-8 text-center group"
            >
              {/* Icon */}
              ...
              {/* Platform name */}
              <p className="text-white-soft font-semibold mb-1">
                {platform.name}
              </p>
